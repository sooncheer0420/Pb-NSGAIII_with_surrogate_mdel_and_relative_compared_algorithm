%% 在PB的基础上，减去GF与RF的的作用，单独检查NSGAIII的效果
clc,clear
...
load('E:\pipe_work_file\20220110_Unpacking\contrast\data\PbNSGAIII\PbNSGAIII0111003.mat','Zrecord')
...
%      filename = 'NSGAIII0111001.mat';
%  save(filename)

IGD=scoreIGD(ii)
HV=scoreHV(ii)
Spacing=scoreSpacing(ii)
GD=scoreGD(ii)
DM=scoreDM(ii)
 save('E:\pipe_work_file\20220110_Unpacking\contrast\data\NSGAIII0111003.mat')